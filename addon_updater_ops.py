...
updater.addon = "mhw_model_editor"
...
def register(bl_info):
    ...
    updater.repo = "MHW_Model_Editor"

    # updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set.
    updater.website = "https://github.com/chikichikibangbang/MHW_Model_Editor"
    ...
    # 用于MHW_Model_Editor
    updater.backup_ignore_patterns = ["__pycache__", "*.tif", "*.png", "*.tex"]
    ...
    # 用于MHW_Model_Editor
    updater.overwrite_patterns = ["*.png", "*.jpg", "*.py", "*.json", "README.md", "LICENSE.txt", "*.ccl"]
