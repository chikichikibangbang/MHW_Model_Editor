...
class WM_OT_MHW_GithubWebsite(Operator):
    ...
    def execute(self, context):
        webbrowser.open("https://github.com/chikichikibangbang/MHW_Model_Editor")
        return {'FINISHED'}

class WM_OT_MHW_IfdianWebsite(Operator):
    bl_idname = "mhw_model.open_ifdian_website"
    bl_label = "Ifdian"

    def execute(self, context):
        webbrowser.open("http://www.ifdian.net/a/korone_suki")
        return {'FINISHED'}