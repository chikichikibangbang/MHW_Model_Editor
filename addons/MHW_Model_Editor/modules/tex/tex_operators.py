...
class WM_OT_Tex_ConvertFolderToTex(Operator):
    ...
    bl_description = "Converts all .dds files in the chosen directory to .tex." \
                     ...
                     "\nSave DDS files with compression settings set to BC7 sRGB for color type textures and BC7 Linear for anything else"
